  ...
  el.innerHTML = `
    <div class="card score-hero">
      ...
      <div class="earned">
        ...
        ${res?.newlyFluent ? `<span class="chip ok">🧠 ${res.newlyFluent} new fluent fact${res.newlyFluent > 1 ? 's' : ''}</span>` : ''}
    ...
    ${weak.length ? `<div class="card" style="margin-top:14px"><h3>Facts to work on</h3><div class="qgrid">${weak.map((w) => `<span class="chip warn">${w.a} × ${w.b} = ${w.a * w.b}</span>`).join('')}</div></div>` : ''}
