...
const TABLE_BADGES = TABLES.map((t) => ({
  ...
  emoji: '🏅',
  name: `${t}s master`,
  description: `Every fact in the ${t} times table is fluent`,
...
export const BADGES = [
  ...
  { id: 'map-half', emoji: '🗺️', name: 'Explorer', description: 'Tried half of all the facts', test: ({ summary }) => summary.exploredPairs >= summary.totalPairs / 2 },
  { id: 'map-full', emoji: '🧭', name: 'Map complete', description: 'Tried every single fact', test: ({ summary }) => summary.exploredPairs >= summary.totalPairs },
  ...
  { id: 'fluent-50', emoji: '🧠', name: 'Big brain', description: 'Half of all facts are fluent', test: ({ summary }) => summary.fluent >= summary.totalFacts / 2 },
  ...TABLE_BADGES,
];
